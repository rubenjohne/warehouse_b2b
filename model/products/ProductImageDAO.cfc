<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="warehouse.model.products.ProductImage">
		...
		<cfscript>
			obj = createObject("component", "warehouse.model.products.ProductImage").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="warehouse.model.products.ProductImage">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="warehouse">
				insert into ts_productimages(productID, description, location, url, contentType, file, fileName, fileExtension, height, width, fileSize, thumbnailFile, thumbnailFileName, thumbnailHeight, thumbnailWidth)
				values (

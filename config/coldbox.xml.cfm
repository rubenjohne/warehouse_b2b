...
<Config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
	...
	<Settings>
		...
		<Setting name="AppName"						value="warehouse"/>
		...
		-->
		<Setting name="AppMapping"					value="/warehouse"/>      
		...
		<Setting name="OwnerEmail" 					value="ruben@tadashicollection.com" />
	...
	<YourSettings>
		...
		<Setting name="PagingMaxRows" 		value="20"/>
		
		<!-- the maximum number of pages in the page carrousel -->
		<Setting name="PagingBandGap" 		value="10"/>
	...
	-->
	<Datasources>
		<Datasource alias="warehouse" name="warehouse"   dbtype="mysql"  username="warehouse" password="rBeatriz21" /> 
	</Datasources>
